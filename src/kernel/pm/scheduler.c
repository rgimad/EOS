...
// We don't need to have a global thread list beacuse each process already has its own thread list
...
void scheduler_init() {
    ...
    kernel_main_thread->kernel_stack = (void*)kernel_stack_top_vaddr;
